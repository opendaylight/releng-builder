...
openstack image create \
  ...
  --file /tmp/apex_snapshots/$CONTROLLER_NODE.raw "ZZCI - OPNFV - apex - controller - 0"
openstack image create \
  --disk-format raw --container-format bare \
  --file /tmp/apex_snapshots/$COMPUTE_0_NODE.raw "ZZCI - OPNFV - apex - compute - 0"
openstack image create \
  --disk-format raw --container-format bare \
  --file /tmp/apex_snapshots/$COMPUTE_1_NODE.raw "ZZCI - OPNFV - apex - compute - 1"
