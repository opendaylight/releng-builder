...
openstack image create \
  ...
  --file apex_snapshots/$CONTROLLER_NODE.qcow2 --name "OPNFV - apex - controller - 0"

openstack image create \
  --disk-format qcow2 --container-format bare \
  --file apex_snapshots/$COMPUTE_0_NODE.qcow2 "OPNFV - apex - compute - 0"

openstack image create \
  --disk-format qcow2 --container-format bare \
  --file apex_snapshots/$COMPUTE_1_NODE.qcow2 "OPNFV - apex - compute - 1"
