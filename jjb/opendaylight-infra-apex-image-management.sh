...
mkdir -p apex_snapshots
pushd apex_snapshots
...
openstack image create \
  ...
  --file apex_snapshots/$CONTROLLER_NODE.qcow2 apex-controller0

openstack image create \
  --disk-format qcow2 --container-format bare \
  --file apex_snapshots/$COMPUTE_0_NODE.qcow2 apex-compute0

openstack image create \
  --disk-format qcow2 --container-format bare \
  --file apex_snapshots/$COMPUTE_1_NODE.qcow2 apex-compute1
