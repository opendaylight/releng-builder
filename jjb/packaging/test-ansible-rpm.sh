...
sudo ansible-playbook -i "localhost," -c local $WORKSPACE/ansible/examples/rpm_8_devel_odl_api.yml -e log_mechanism=console -e '{"log_levels":{"root":{"log_name":"rootLogger", "log_level":"DEBUG"}}}'
