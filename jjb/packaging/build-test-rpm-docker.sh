...
wget http://download.opensuse.org/distribution/leap/42.3/repo/non-oss/suse/repodata/repomd.xml
...
sudo docker exec $docker_id ping 8.8.8.8 -c 4

sudo docker exec $docker_id ping www.google.de -c 4

sudo docker exec $docker_id ping download.opensuse.org -c 4
