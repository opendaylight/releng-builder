...
sudo docker exec $docker_id git -C /builder fetch https://git.opendaylight.org/gerrit/releng/builder refs/changes/01/68201/18
...
sudo docker cp $docker_id:/root/rpmbuild/RPMS/noarch/*.rpm "$_"

sudo docker cp $docker_id:/root/rpmbuild/SRPMS/*.rpm "$_"
