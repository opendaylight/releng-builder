...
# Just to test this patch. As soon as this get merged, we will remove these two lines
sudo docker exec $docker_id git --git-dir /builder/.git --work-tree /builder fetch https://git.opendaylight.org/gerrit/releng/builder refs/changes/61/68861/12
