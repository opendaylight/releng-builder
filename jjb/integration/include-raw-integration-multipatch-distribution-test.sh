...
# Set up git user and email, needed to make commits when cherry-picking.
git config user.email sandbox@jenkins.opendaylight.org
git config user.name Multipatch Job
