...
do
    ...
    ${SSH} $ip "sudo ovs-vsctl add-br $PUBLIC_BRIDGE -- set bridge $PUBLIC_BRIDGE other-config:disable-in-band=true other_config:hwaddr=f6:00:00:ff:01:0$((index++))"
done
...
do
    ...
    PORT_NAME=${OPENSTACK_CONTROL_NODE_IP}_vx
