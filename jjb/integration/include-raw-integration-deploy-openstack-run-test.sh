...
do
    # FIXME - Workaround, ODL currently adds br-physnet1 as a port in br-int since it doesn't see such a bridge existing when we stack
...
# Control Node - br-physnet1 will act as the external router
${SSH} ${OPENSTACK_CONTROL_NODE_IP} "sudo ifconfig br-physnet1 up 10.10.10.250/24" # FIXME this should be a parameter
compute_index=1
