...
${SSH} ${OPENSTACK_CONTROL_NODE_IP} "sudo ip link add link ${PUBLIC_PHYSICAL_NETWORK} name  ${PUBLIC_PHYSICAL_NETWORK}.167 type vlan id 167"
${SSH} ${OPENSTACK_CONTROL_NODE_IP} "sudo ifconfig  ${PUBLIC_PHYSICAL_NETWORK} up"
${SSH} ${OPENSTACK_CONTROL_NODE_IP} "sudo ifconfig   ${PUBLIC_PHYSICAL_NETWORK}.167 up ${GATEWAY_IP}/24"
compute_index=1
