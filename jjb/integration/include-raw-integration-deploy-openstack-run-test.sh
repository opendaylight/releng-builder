...
do
    ...
    scp ${!OSIP}:/etc/kuryr/kuryr.conf ${OS_COMPUTE_FOLDER}/kuryr.conf
    scp ${!OSIP}:/etc/neutron/neutron_lbaas.conf ${OS_COMPUTE_FOLDER}/neutron-lbaas.conf
    scp ${!OSIP}:/etc/neutron/services/loadbalancer/haproxy/lbaas_agent.ini ${OS_COMPUTE_FOLDER}/lbaas-agent.ini
