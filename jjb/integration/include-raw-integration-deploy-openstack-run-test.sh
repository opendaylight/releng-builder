...
do
    ...
    echo "sleep for 20s and print hypervisor-list"
    sleep 20
...
# FIXME hardcoded for 1st sites HAPROXY - this is used for debugging in int/test
if [ "${ENABLE_HAPROXY_FOR_NEUTRON}" == "yes" ]; then
...
pybot -N ${TESTPLAN} --removekeywords wuks -c critical -e exclude \
    ...
    -v NUM_OS_SYSTEM:${NUM_OPENSTACK_SITES} \
