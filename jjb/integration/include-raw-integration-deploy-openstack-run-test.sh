...
echo "sleep for a minute and print hypervisor-list"
sleep 60
ssh ${OPENSTACK_COMPUTE_NODE_1_IP} "cd /opt/stack/devstack; source openrc admin admin; nova hypervisor-list"
...
echo "sleep for a minute and print hypervisor-list"
sleep 60
ssh ${OPENSTACK_COMPUTE_NODE_2_IP} "cd /opt/stack/devstack; source openrc admin admin; nova hypervisor-list"
