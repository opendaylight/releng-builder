...
do
    ...
    scp  ${WORKSPACE}/test/tools/clustering/cluster-deployer/templates/openflow/akka.conf.template ${CONTROLLERIPS[$i]}:${AKKACONF}
    scp  ${WORKSPACE}/test/tools/clustering/cluster-deployer/templates/openflow/modules.conf.template ${CONTROLLERIPS[$i]}:${MODULESCONF}
    scp  ${WORKSPACE}/test/tools/clustering/cluster-deployer/templates/openflow/module-shards.conf.template ${CONTROLLERIPS[$i]}:${MODULESHARDSCONF}
    scp  ${WORKSPACE}/test/tools/clustering/cluster-deployer/templates/openflow/jolokia.xml.template ${CONTROLLERIPS[$i]}:${JOLOKIACONF}
