...
sed -ie "s/featuresBoot=.*/featuresBoot=config,standard,region,package,kar,ssh,management,decanter-collector-jmx,decanter-appender-elasticsearch,${ACTUALFEATURES}/g" \${FEATURESCONF}
