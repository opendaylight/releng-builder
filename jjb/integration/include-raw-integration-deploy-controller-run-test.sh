...
-v CONTROLLER:${ODL_SYSTEM_IP} -v CONTROLLER_USER:${USER} \
-v JAVA_HOME:${JAVA_HOME} -v JDKVERSION:${JDKVERSION} \
-v MININET1:${TOOLS_SYSTEM_2_IP} -v MININET2:${TOOLS_SYSTEM_3_IP} \
-v MININET3:${TOOLS_SYSTEM_4_IP} -v MININET4:${TOOLS_SYSTEM_5_IP} -v MININET5:${TOOLS_SYSTEM_6_IP} \
-v MININET:${TOOLS_SYSTEM_IP} -v MININET_USER:${USER} \
-v NEXUSURL_PREFIX:${NEXUSURL_PREFIX} -v NUM_ODL_SYSTEM:${NUM_ODL_SYSTEM} \
-v ODL_STREAM:${DISTROSTREAM} -v ODL_SYSTEM_1_IP:${ODL_SYSTEM_IP} -v ODL_SYSTEM_IP:${ODL_SYSTEM_IP} -v ODL_SYSTEM_USER:${USER} \
-v TOOLS_SYSTEM_2_IP:${TOOLS_SYSTEM_2_IP} -v TOOLS_SYSTEM_3_IP:${TOOLS_SYSTEM_3_IP} \
-v TOOLS_SYSTEM_4_IP:${TOOLS_SYSTEM_4_IP} -v TOOLS_SYSTEM_5_IP:${TOOLS_SYSTEM_5_IP} -v TOOLS_SYSTEM_6_IP:${TOOLS_SYSTEM_6_IP} \
-v TOOLS_SYSTEM_IP:${TOOLS_SYSTEM_IP} -v TOOLS_SYSTEM_USER:${USER} \
