...
ls -l "tmp/r"
ls -l "tmp/r/org"
ls -l "tmp/r/org/opendaylight"
ls -l "tmp/r/org/opendaylight/integration"
ls -l "tmp/r/org/opendaylight/integration/${KARAF_ARTIFACT}"
ls -l "tmp/r/org/opendaylight/integration/${KARAF_ARTIFACT}/${BUNDLE_VERSION}"
ls -l "$BUNDLE_URL"
