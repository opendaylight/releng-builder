...
do
    ...
    if [ "x${CHECKOUT}" != "x" ]; then
        ...
        if [ "${PROJECT}" == "odlparent" -o "${PROJECT}" == "yangtools" -o \( "${PROJECT}" == "mdsal" -a "${DISTROSTREAM}" != "fluorine" \) ]; then
        ...
        if [ "${PROJECT}" == "yangtools" -o \( "${PROJECT}" == "mdsal" -a "${DISTROSTREAM}" != "fluorine" \) ]; then
        ...
        if [ "${PROJECT}" == "mdsal" -a "${DISTROSTREAM}" != "fluorine" ]; then
