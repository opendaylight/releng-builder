...
ssh $OPENSTACK_COMPUTE_NODE_1_IP "sudo find / -name \"*ml2*\""



ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/#physical_network_mtus =/physical_network_mtus = datacentre:1458/' /etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/#physical_network_mtus =/physical_network_mtus = datacentre:1458/' /var/lib/config-data/puppet-generated/neutron/etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /var/lib/config-data/puppet-generated/neutron/etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/#physical_network_mtus =/physical_network_mtus = datacentre:1458/' /var/lib/config-data/neutron/etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /var/lib/config-data/neutron/etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/^path_mtu=0.*//' /etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/^path_mtu=0.*//' /var/lib/config-data/puppet-generated/neutron/etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /var/lib/config-data/puppet-generated/neutron/etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/^path_mtu=0.*//' /var/lib/config-data/neutron/etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /var/lib/config-data/neutron/etc/neutron/plugins/ml2/ml2_conf.ini"

ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/#path_mtu.*/path_mtu = 1458/' /etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/#path_mtu.*/path_mtu = 1458/' /var/lib/config-data/puppet-generated/neutron/etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /var/lib/config-data/puppet-generated/neutron/etc/neutron/plugins/ml2/ml2_conf.ini"
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo sed -i 's/#path_mtu.*/path_mtu = 1458/' /var/lib/config-data/neutron/etc/neutron/plugins/ml2/ml2_conf.ini; sudo cat /var/lib/config-data/neutron/etc/neutron/plugins/ml2/ml2_conf.ini"
...
ssh $OPENSTACK_CONTROL_NODE_1_IP "sudo tcpdump -i eth0 -n -w /tmp/dhcp_capture.pcap port 67 and port 68 &"
