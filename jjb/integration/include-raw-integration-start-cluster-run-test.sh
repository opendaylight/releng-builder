...
${odl_variables} -v CONTROLLER_USER:${USER} -v ODL_SYSTEM_USER:${USER} -v TOOLS_SYSTEM_IP:${TOOLS_SYSTEM_IP} \
${tools_variables} -v TOOLS_SYSTEM_USER:${USER} -v MININET:${TOOLS_SYSTEM_IP} -v MININET1:${TOOLS_SYSTEM_2_IP} \
-v MININET2:${TOOLS_SYSTEM_3_IP} -v MININET_USER:${USER} -v USER_HOME:${HOME} ${TESTOPTIONS} ${SUITES} || true
