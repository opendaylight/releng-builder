...
-v CONTROLLER_USER:${USER} -v TEST_PARTNER:${TEST_PARTNER0} -v TEST_PARTNER1:${TEST_PARTNER1} -v TEST_PARTNER2:${TEST_PARTNER2} \
-v TEST_PARTNER_USER:${USER} -v USER_HOME:${HOME} ${TESTOPTIONS} ${SUITES} || true
