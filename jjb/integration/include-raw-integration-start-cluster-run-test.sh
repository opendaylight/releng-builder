...
${odl_variables} -v NUM_ODL_SYSTEM:${CONTROLLERCOUNT} -v CONTROLLER_USER:${USER} -v ODL_SYSTEM_USER:${USER} -v \
TOOLS_SYSTEM_IP:${TOOLS_SYSTEM_IP} ${tools_variables} -v NUM_TOOLS_SYSTEM:${MININETCOUNT} -v TOOLS_SYSTEM_USER:${USER} \
