...
pybot -N ${TESTPLAN} -c critical -e exclude --loglevel TRACE -v \
BUNDLEFOLDER:${BUNDLEFOLDER} -v WORKSPACE:/tmp -v \
CONTROLLER:${CONTROLLER0} -v CONTROLLER1:${CONTROLLER1} -v CONTROLLER2:${CONTROLLER2}  -v MININET:${MININET0} -v MININET_USER:${USER} -v USER_HOME:${HOME} ${TESTOPTIONS} ${SUITES}
