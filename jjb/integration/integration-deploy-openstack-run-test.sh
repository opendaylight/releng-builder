...
echo "baseurl=http://vault.centos.org/7.4.1708/os/x86_64/" | sudo tee -a /etc/yum.repos.d/centos-vault.repo
...
EOF
   ...
   ${SSH} ${OSNODE} "sudo bash /tmp/install_ovs_with_nsh.sh > /tmp/install_ovs_nsh.txt 2>&1"
