...
sudo mkdir /vm_instances;chmod -R 777 /vm_instances
sudo yum install -y nfs-utils
echo /vm_instances *\\(rw,no_root_squash\\) >> /etc/exports
...
sudo yum install -y libvirtd nfs-utils
...
sudo mkdir -p /var/instances;chmod -R 777 /var/instances
