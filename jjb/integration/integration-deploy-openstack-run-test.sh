...
cd /opt/stack
git clone https://git.openstack.org/openstack/networking-sfc --branch ${OPENSTACK_BRANCH}
sed -i 's/q-svc/neutron-api' /opt/stack/networking-sfc/devstack/plugin.sh
EOF
