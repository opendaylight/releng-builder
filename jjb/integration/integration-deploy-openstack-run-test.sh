...
function add_services() {
    local core_os_services=$1
    local enable_os_services=$2
    local disable_os_services=$3
...
EOF
    ...
    add_services "${CORE_OS_CONTROL_SERVICES}" "${ENABLE_OS_SERVICES}" "${DISABLE_OS_SERVICES}" "${local_conf_file_name}"
...
EOF
    ...
    add_services "${CORE_OS_COMPUTE_SERVICES}" "${ENABLE_OS_COMPUTE_SERVICES}" "${DISABLE_OS_SERVICES}" "${local_conf_file_name}"
