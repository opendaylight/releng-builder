...
echo "showing recent changes that made it into the distribution used by this job:"
...
echo "showing recent changes that made it into integration/test used by this job:"
cd ${WORKSPACE}/test
