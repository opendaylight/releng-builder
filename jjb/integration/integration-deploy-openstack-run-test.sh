...
if [ -e output_tempest.xml ]; then
    ...
    rebot --output output_no_tempest.xml --log log_no_tempest.html --report None --merge output_*.xml || true
    mv skip_output_tempest.xml output_tempest.xml
fi
rebot --output output.xml --log None --report None --merge output_*.xml || true
