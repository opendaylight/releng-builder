...
BUNDLEURL="${BUILD_URL}org.opendaylight.integration\$snapshot-karaf/snapshot-karaf-distribution/artifact/org.opendaylight.integration/snapshot-karaf-distribution/${BUNDLEVERSION}/snapshot-karaf-distribution-${BUNDLEVERSION}.zip"
