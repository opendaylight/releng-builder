...
echo "-----END_OF_BUILD-----"
wget --no-verbose -O $ARCHIVES_DIR/console.log ${{BUILD_URL}}consoleText
wget --no-verbose -O $ARCHIVES_DIR/console-timestamp.log "${{BUILD_URL}}/timestamps?time=HH:mm:ss&appendLog"
