...
# TODO: This section is still required since some of the projects use description.
# Remove this section when the reactor info in log is more consistant.
# extract the failing project from reactor information
