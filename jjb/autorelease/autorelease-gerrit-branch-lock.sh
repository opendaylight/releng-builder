...
if [ "${SUPERCOMMITTERS}" = true ] && [ "${CODE_FREEZE}" = false ] && [ "${RELEASE_PREP}" = false ] && [ "${UNLOCK}" = false ]; then
    mode=supercommitters
elif [ "${CODE_FREEZE}" = true ] && [ "${SUPERCOMMITTERS}" = false ] && [ "${RELEASE_PREP}" = false ] && [ "${UNLOCK}" = false ]; then
    mode=code-freeze
elif [ "${RELEASE_PREP}" = true ] && [ "${SUPERCOMMITTERS}" = false ] && [ "${CODE_FREEZE}" = false ] && [ "${UNLOCK}" = false ]; then
    mode=release-prep
elif [ "${UNLOCK}" = true ] && [ "${SUPERCOMMITTERS}" = false ] && [ "${RELEASE_PREP}" = false ] && [ "${CODE_FREEZE}" = false ]; then
    mode=unlock
else
    mode=none
fi
