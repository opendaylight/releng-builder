...
echo '---> Install OpenVSwitch 2.8.1'
apt-get update -m
...
tar -xzvf openvswitch-2.8.1.tar.gz -C /root/ovs --strip-components=1
cd /root/ovs
DEB_BUILD_OPTIONS='parallel=8 nocheck' fakeroot debian/rules binary
cd /root
dpkg -i openvswitch-common_2.8.1-1_amd64.deb openvswitch-switch_2.8.1-1_amd64.deb python-openvswitch_2.8.1-1_all.deb openvswitch-vtep_2.8.1-1_amd64.deb
...
# shellcheck disable=SC2009
ps -elf | grep vtep
echo '---> Finished installing OpenVSwitch 2.8.1'
