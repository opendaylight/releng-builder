...
[https://jenkins.opendaylight.org/releng/][3]
...
### <a name="jjb_install_docker">Using Docker</>
...
### <a name="jjb_install_manual">Manual Install</>
...
TODO: venvwrapper docs
TODO: Intro to dep/JJB install step
...
[https://jenkins.opendaylight.org/sandbox][27]
...
similarly to the master instance, although it cannot publish artifacts or vote
in Gerrit.
...
JJB reads user-specific configuration from a `jenkins.ini` file. An example
is provided at [`builder/jenkins.ini.example`][28].
    ...
    # Edit jenkins.ini with your username, password and ODL's sandbox URL
    $ cat jenkins.ini
    <snip>
    [jenkins]
    user=<your ODL username>
    password=<your ODL password>
...
**Important Note:** When pushing with `jenkins-jobs` command, it will print
...
If you followed the [Docker install method](#jjb_install_docker), use TODO
...
[29]: https://hub.docker.com/r/zxiiro/jjb-docker/
[30]: https://virtualenvwrapper.readthedocs.org/en/latest/
[31]: https://virtualenvwrapper.readthedocs.org/en/latest/install.html
