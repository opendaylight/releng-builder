...
The recommended version of JJB is unstable, so both source and pip-based
installs are documented below.

As of Nov. 19th 2015, JJB version 1.2.0 is recommended.
